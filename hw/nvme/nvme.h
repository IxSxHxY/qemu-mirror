...
#define PHISON_MODEL_MMIO_RESULT_SUCCESS (1) // Generic Reply
#define PHISON_MODEL_MMIO_RESULT_MSIX (2) // Any SQE
#define PHISON_MODEL_MMIO_RESULT_MARK_VEC_USE (3) // RPC from create IOCQ
#define PHISON_MODEL_MMIO_RESULT_MARK_VEC_UNUSE (4) // RPC from delete IOCQ
#define PHISON_MODEL_MMIO_RESULT_DEACTIVATE_BRIDGE_LINK (5) // RPC from PERST assert
#define PHISON_MODEL_MMIO_RESULT_ACTIVATE_BRIDGE_LINK (6) // RPC from PERST deassert
